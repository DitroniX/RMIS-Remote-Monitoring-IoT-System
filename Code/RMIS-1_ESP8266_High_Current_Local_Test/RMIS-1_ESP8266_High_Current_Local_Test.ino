/*
  ...
  PCA v1.00 - Test Code Firmware v1.1 - 29th April 2022
...
const int AverageSamples = 50; // Average Multi-Samples on each Channel.
...
void loop() {
  ...
  Serial.print("Ch "); Serial.print(1);
  Serial.println("");

  // **************** CURRENT ****************

  Serial.print(CalculateAverage(0)); Serial.print("\t");
  Serial.println(" Current RAW ADC Value");

  Serial.print( ((CalculateAverage(2) - 512) / 13.25)); Serial.print("\t");
  Serial.println(" Calculated Current A -/+");

  Serial.println("");
    
  
  Serial.print(CalculateAverage(2)); Serial.print("\t");
  Serial.println(" Current RAW ADC Value");
  ...
  Serial.print(CalculateAverage(0) + CalculateAverage(2)); Serial.print("\t");
  Serial.println(" Combined Current RAW ADC Value");

  Serial.print( ((CalculateAverage(0) - 512) / 13.25) + ((CalculateAverage(2) - 512) / 13.25)); Serial.print("\t");
  Serial.println(" Combined Calculated Current A -/+");

  Serial.println("---------------");

  // **************** VOLTAGE ****************

  Serial.print(CalculateAverage(1)); Serial.print("\t");
  Serial.println(" Voltage RAW ADC Value");

  Serial.print( ( CalculateAverage(1) * 117.87 ) / 1024 ) ; Serial.print("\t");  // RMIS-1-60
